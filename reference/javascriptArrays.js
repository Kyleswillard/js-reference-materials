...
removes from middle somewhere.
 ...
 Solution 1 - 2nd Best Case
declare a new array if a let.
...
combined.slice(2, 4)
slice(start index{optional, clones array}, end index{optional}) grabs ALL array indexes between.
...
Expected output: [1, 2, 3,'a', 'b,' 4, 5, 6]
...
forEach()
 performs function on EACH element in an array.
...
ASCII Table => values
 ...
 .Every
compares each element in array to see if fits parameters (true/false, positive/negative)
const numbers [1, 2, 3]
...
loop array, and if matches adds to new array
